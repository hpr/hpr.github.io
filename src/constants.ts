...
// via https://github.com/GlaivePro/IaafPoints/blob/wa-2022/resources/iaaf/2022.php
export const points22 = {
  outdoor: {
    ...
    f: {
      ...
      marathon: {
        resultShift: -22800,
        conversionFactor: 5.95e-6,
        pointShift: 0,
      },
      '100km': {
        resultShift: -61200,
        conversionFactor: 8.74e-7,
        pointShift: 0,
      },
      '3kmW': {
        resultShift: -1871,
